const app = new PIXI.Application({
    ...
    resolution: window.devicePixelRatio / 1.5 || 1,
});

document.body.appendChild(app.view);
const sprite = PIXI.Sprite.from('assets/map.png');
...
const teatr_dor1 = PIXI.Sprite.from('./assets/teatr_door1.png');
const teatr_dor2 = PIXI.Sprite.from('./assets/teatr_door2.png');
...
const inside_the_theater_image = PIXI.Sprite.from('assets/teatr.png');
...
const superrot1 = PIXI.Sprite.from('./assets/supermarket1.png');
const superrot2 = PIXI.Sprite.from('./assets/supermarket2.png');
...
const bunny = PIXI.Sprite.from('assets/player.png');
